...
Function W_GetRedBookData(ws)
    ...
    combined1 = A_HStackH1(arr_make, arr_model)
    combined2 = A_HStackH1(combined1, arr_group)
...
End Sub
Function Rg_PickTilEnd(rng, Optional direction As XlDirection = xlDown) As range
    Dim ws As Worksheet
    Set ws = rng.Parent
