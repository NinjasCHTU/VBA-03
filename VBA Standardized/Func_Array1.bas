...
Function A_HStack(arr1, arr2)
    ...
    If n_row1 <> n_row2 Then
        A_HStack = "The number of column is not equal"
        Exit Function
    End If
    Dim out_arr() As Variant
...
End Function
Function A_IsEmpty(arr_in)
    text_test = Join(arr_in)
    If text_test = "" Then A_IsEmpty = True Else A_IsEmpty = False
